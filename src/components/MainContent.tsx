...
const MainContent: React.FC = () => {
  ...
  return (
    <main className="flex-1 bg-gradient-to-br from-[#1a1333] to-[#231a3a] p-8 min-h-screen overflow-y-auto">
      {/* Featured NFT Card */}
      <div className="flex flex-col lg:flex-row gap-8 mb-8">
        <div className="flex-1 bg-gradient-to-tr from-purple-700 to-blue-800 rounded-2xl p-6 flex flex-col md:flex-row items-center shadow-lg">
        ...
        <div className="w-full lg:w-80 flex flex-col gap-6">
          <div className="bg-gradient-to-tr from-purple-800 to-blue-900 rounded-2xl p-6 shadow-lg flex flex-col items-center">
          ...
          {/* ETH Rate Card */}
          <div className="bg-gradient-to-tr from-purple-800 to-blue-900 rounded-2xl p-6 shadow-lg">
            ...
            <div className="mt-4">
              <div className="w-full h-16 bg-purple-900 rounded-lg flex items-center justify-center text-purple-400">Graph</div>
      ...
      {/* Create NFT Banner */}
      <div className="bg-gradient-to-tr from-[#231a3a] to-[#2d185a] rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between mb-8 shadow-lg">
        <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[1,2,3,4].map(i => (
            <div key={i} className="bg-gradient-to-tr from-purple-700 to-blue-800 rounded-2xl p-4 shadow-lg">
